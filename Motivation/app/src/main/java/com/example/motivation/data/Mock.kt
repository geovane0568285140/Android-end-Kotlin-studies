...
class Mock {
    ...
    private val all: Int = PreferencesConstants.categoryId.BaselineAll
    private val happy: Int = PreferencesConstants.categoryId.BaselineEmojiEmotions
    private val sunny: Int = PreferencesConstants.categoryId.BaselinaSunny

    private val langPt: String = PreferencesConstants.LENGUAGE.PORTUGUESE
    private val langEn: String = PreferencesConstants.LENGUAGE.ENGLiSH
  ...
  private val listPhrase = listOf<Phrase>(
    ...
    fun getPhrase(categorySelect: Int, lang: String): String{
        val filtred = listPhrase.filter { (it.categoryid == categorySelect || categorySelect == all) && it.lang == lang}
